...
app.secret_key = "AIT526" # Required for session management
    # A Retrieval-Augmented Generation (RAG) chatbot for answering user queries by retrieving relevant content from a pre-scraped JSON file and optionally using an OpenAI-compatible local LLM for advanced responses.
...
chatbot = InteractiveRAGChatBot(data_path=r"C:\Users\samee\OneDrive\Desktop\InfoTech Assistant\InfoBridge_scraped_data.json") 
